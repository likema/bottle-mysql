...
# This ugly hack executes the first few lines of the module file to look up
# some common variables. We cannot just import the module because it depends
# on other modules that might not be installed yet.
